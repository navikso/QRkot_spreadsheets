...
async def get_spreadsheets_from_disk(
    ...
    spreadsheets = await wrapper_service.as_service_account(service.files.list(q=f'mimeType="application/vnd.google-apps.spreadsheet" and name="{spreadsheet_title}"')
